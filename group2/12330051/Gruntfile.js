...
(function() {
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      concat: {
        build_css: {
          src: ["bin/**/*.css", "!bin/<%= pkg.name %>*.css", "!bin/vendor/**/*.css", "!bin/tests/**/*.css", "!bin/**/debug.css"],
    ...
    grunt.registerTask("watch", ["clean", "build", "express", "delta"]);
    grunt.registerTask("default", ["build"]);
    return grunt.registerTask("build", ["livescript", "sass", "copy"]);
  };
